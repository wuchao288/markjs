    ...
    <template #header>
      <div class="card-header">
        ...
        <div class="panel-block">
            ...
            <div class="panel-block_body">
              <el-row class="panel-resource-list">
                    <el-col @click="createImage(img.url)" :span="6" class="panel-resource-list-item"  v-for="img in  ImageEffectList.filter((m,idex)=>idex<3)">
        ...
        <div class="panel-block">
            ...
            <div class="panel-block_body">
              <el-row class="panel-resource-list">
                    <el-col @click="createImage(img.url)" :span="6" class="panel-resource-list-item"  v-for="img in  ImageEffectList.filter((m,idex)=>idex<7)">
                        <img :src="img.preview" lazy loading="lazy"  />
                    </el-col>
                </el-row>
            </div>
...
let groupText=_.groupBy(ImageEffectList,item=>item.cateName)
